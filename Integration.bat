...
cd %PROJECT_DIR%
call mvn -Dmaven.compiler.target=1.8 -Dmaven.compiler.source=1.8 -DskipTests clean deploy
...
set PROJECT_DIR=..\..\INTEGRATION_CLIENTS\transunion-cibil
cd %PROJECT_DIR%
call mvn -Dmaven.compiler.target=1.8 -Dmaven.compiler.source=1.8 -DskipTests clean deploy
...
set PROJECT_DIR=..\..\CanaraIntegrations
cd %PROJECT_DIR%
call mvn -Dmaven.compiler.target=1.8 -Dmaven.compiler.source=1.8 -DskipTests clean deploy
